...
public class NatureAutocompleteHandler : AutocompleteHandler
{
        ...
        IServiceProvider services)
    {
        try
        {
            ...
            {
                finalResults.Add(new AutocompleteResult(SysBot.Pokemon.Localization.AppLocalization.Get(SysBot.Pokemon.Localization.LocalizationKeys.DiscordAutocompleteNoMatches), "Adamant"));
            }
