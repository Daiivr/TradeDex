...
public static class ReusableActions
{
    ...
    public static async Task SendPKMAsShowdownSetAsync(this ISocketMessageChannel channel, PKM pkm, SocketUserMessage userMessage)
    {
        ...
        var embed = new EmbedBuilder()
            .WithTitle(AppLocalization.Get(LocalizationKeys.DiscordShowdownSetTitle))
            .WithDescription(txt)
        ...
        var warningMessage = await channel.SendMessageAsync(AppLocalization.Get(LocalizationKeys.DiscordShowdownSelfDestruct)).ConfigureAwait(false);
