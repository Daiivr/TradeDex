...
public static class AutoLegalityWrapper
{
    ...
    static AutoLegalityWrapper()
    {
        AppLocalization.LanguageChanged += (_, _) => InitializeCoreStrings();
    }
    ...
    public static SimpleTrainerInfo GetFallbackTrainer()
    {
        if (ConfiguredSettings == null)
            throw new InvalidOperationException("AutoLegalityWrapper no ha sido inicializado. Llama a EnsureInitialized primero.");
    ...
    {
        var lang = AppLocalization.Language switch
        {
