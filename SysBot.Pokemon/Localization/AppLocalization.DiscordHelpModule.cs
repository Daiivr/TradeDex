    ...
    private static void AddDiscordHelpModuleTranslations(Dictionary<string, string> target, AppLanguage language)
    {
        switch (language)
        {
            case AppLanguage.English:
                ...
                target[LocalizationKeys.DiscordHelpCommandNotFound] = "⚠️ {0}, sorry, I couldn't find a command like **{1}**.";
                ...
                target[LocalizationKeys.DiscordHelpDescription] = "📝 These are the commands you can use, organized by module.";
                target[LocalizationKeys.DiscordHelpTipFooter] = "Tip: use {0}help <command> to see details and parameters";
            ...
            case AppLanguage.Spanish:
                ...
                target[LocalizationKeys.DiscordHelpCommandNotFound] = "⚠️ {0}, lo siento, no pude encontrar un comando como **{1}**.";
                ...
                target[LocalizationKeys.DiscordHelpDescription] = "📝 Estos son los comandos que puedes usar, organizados por modulo.";
                target[LocalizationKeys.DiscordHelpTipFooter] = "Consejo: usa {0}help <comando> para ver detalles y parametros";
                target[LocalizationKeys.DiscordHelpModuleField] = "📦 {0}";
