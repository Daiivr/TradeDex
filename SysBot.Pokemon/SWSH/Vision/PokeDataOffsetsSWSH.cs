...
public class PokeDataOffsetsSWSH
{
    ...
    public static uint GetTrainerNameOffset(TradeMethod tradeMethod) => tradeMethod switch
    {
        ...
        _ => throw new ArgumentException("El desplazamiento del nombre del entrenador no está disponible para este método de intercambio.", nameof(tradeMethod)),
    };
    ...
    public static uint GetTrainerTIDSIDOffset(TradeMethod tradeMethod) => tradeMethod switch
    {
        ...
        _ => throw new ArgumentException("El desplazamiento de TID/SID del entrenador no está disponible para este método de intercambio.", nameof(tradeMethod)),
    };
}
