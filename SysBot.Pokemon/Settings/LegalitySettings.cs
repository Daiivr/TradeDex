...
public class LegalitySettings
{
    ...
    [Category(Generate), Description("El bot creará un Pokémon Huevo de Pascua si se le proporciona un conjunto ilegal."), DisplayName("Habilitar los Huevos de Pascua?")]
