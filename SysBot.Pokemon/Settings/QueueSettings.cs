...
public class QueueSettings
{
    ...
    [Category(FeatureToggle), Description("Cuando esta habilitado, envia una notificacion embed a los canales de anuncios cuando la cola se cierra por capacidad maxima.")]
